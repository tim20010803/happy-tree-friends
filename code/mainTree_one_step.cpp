...
int main() {
    ...
    // this part of code is to test the run time of different thread number, theta
    ...
    //         std::string str = "../initial_condition/one_step_data.csv";
    ...
    //This part of code is for orbit integration
    double t=3. ,dt = 0.005;
    int num_steps = t / dt;
    ...
    QuadrupleTree T(1,8,particles, -1 * grid_range, -1 * grid_range, -1 * grid_range, grid_range, grid_range, grid_range);
