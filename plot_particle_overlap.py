...
def update_overlay( frame ):
    ...
    plt.scatter(positions_x, positions_y, c='red', s=1, marker='o', alpha=1, label='Tree', edgecolor='none')
    plt.scatter(positions_x_non, positions_y_non, c='#7FFF00', s=1, marker='o', alpha=0.7,label='NonTree', edgecolor='none')
